 ...
 * @see uniformMatrix
 */
var ALPHA_MASK, BLUE_MASK, DOWN, FACE_BACK, FACE_BOTTOM, FACE_FRONT, FACE_LEFT, FACE_RIGHT, FACE_TOP, GREEN_MASK, MAX_FACES_PER_BATCH, Matrix4x4, RED_MASK, UP, VERTS_PER_FACE, Vec3, XYZs, addElementButton, addTagButton, background, backgroundColor, boxDottedStroke, boxStroke, bringUpElementList, cam, camera, cameraDirectionX, cameraDirectionY, cameraDirectionZ, cameraFOV, cameraMoveForward, cameraMoveSide, cameraMoveUp, cameraVectorAhead, cameraX, cameraY, cameraZ, canvasElement, canvasHeight, canvasWidth, chooseElementByName, colorIntFromRGB, colorIntToGLArray, colorModeA, colorModeX, colorModeY, colorModeZ, containerBox, createProgramObject, curContext, curContextCache, currentElementList, currentFillColor, currentStrokeColor, doFill, doStroke, dottedLine, elementChosenByUserToBeAddedToWorld, elementColor, elementDensity, elementName, elementSelectList, elements, elementsCount, elementsInTag, face, faceBuffer, faceVerts, facesInBatchSoFar, fill, fillStyle, flushFaces, fps_frameCount, fragmentShaderSrcFaces, fragmentShaderSrcLines, fragmentShaderSrcRects, frustum, getGLContext, getUrlVars, gridSizeX, gridSizeY, gridSizeZ, handleKeydown, handleKeyup, horizontalMotionProbability, initCanvasWebGLAndCamera, initMainDataStructures, initUI, instrumentation_countParticles, instrumentation_countParticles_t0, instrumentation_countParticles_tf, invertHorizMouseDrag, isKeyPressed, justInFrontOfRayCastSlot, keyPressed, lastSelectedForTag, last_fps_count_time, line, lineBuffer, modelView, mouseDraggedLeftButton, mouseSensitivity, mouseX, mouseY, neighborProbability, newArray, noFill, noStroke, numberOfParticles, particleAt, particleNextTickAt, particlesMotion, particlesMotion_t0, particlesMotion_tf, particlesReactions, particlesReactions_t0, particlesReactions_tf, pauseReactionsAndMotion, pauseRendering, perm4, perm5, perm6, perspective, physicsMode, pitch, previousMouseX, previousMouseY, programObjectFaces, programObjectLines, programObjectRects, projection, rayCast, rayCastSlot, reactionOptions, rect, rectBuffer, rectVerts, renderCubes, render_t0, render_tf, scenario0, scenario1, scenario10, scenario11, scenario12, scenario13, scenario14, scenario15, scenario16, scenario17, scenario18, scenario19, scenario2, scenario3, scenario4, scenario5, scenario6, scenario7, scenario8, scenario9, shuffledDirections, shuffledProbs, size, slowDown, stroke, strokeStyle, tagButtonPressed, tags, tick, ticks, transmutationProbability, transmutationTo, uElementIDAndSide, uElementsColors, uniformMatrix, uniformf, uniformi, updateCamera, updateChosenItemBasedOnSelect, userManuallyClickedOnSelectListEntry, vertexAttribPointer, vertexShaderSrcFaces, vertexShaderSrcLines, vertexShaderSrcRects, verticalMotionProbability, workSpaceX, workSpaceY, workSpaceZ, yaw,
  splice = [].splice,
