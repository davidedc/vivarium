...
placeUserPickedElementInSelectedSlot = function() {
...
canvasElement.addEventListener('mousedown', function(e) {
  if (e.buttons === 2) {
    return placeUserPickedElementInSelectedSlot();
  }
});
...
handleKeydown = function(e) {
  ...
  if ((currentlyOpenModal !== examplesModal) && (e.key === "ArrowLeft" || e.key === "ArrowRight" || e.key === "ArrowUp" || e.key === "ArrowDown")) {
    e.preventDefault();
  }
  return true;
};
