...
navigationHelpButton.onclick = function() {
...
navigationHelpCloseButton.onclick = function() {
...
examplesModalCloseButton.onclick = function() {
...
updateCamera = function() {
  var cameraToAddLookX, cameraToAddLookY, cameraToAddLookZ, cameraToAddPosX, cameraToAddPosY, cameraToAddPosZ, ref, ref1, tiltLimit;
  tiltLimit = 0;
  ...
  ref = cameraVectorAhead(cameraMoveForward, cameraMoveSide, cameraMoveUp), cameraToAddPosX = ref[0], cameraToAddPosY = ref[1], cameraToAddPosZ = ref[2];
  cameraX += cameraToAddPosX;
  cameraY += cameraToAddPosY;
  cameraZ += cameraToAddPosZ + cameraMoveUp / 2;
  ref1 = cameraVectorAhead(1, 0, 0), cameraToAddLookX = ref1[0], cameraToAddLookY = ref1[1], cameraToAddLookZ = ref1[2];
...
rayCast = function() {
  var cameraToAddPosX, cameraToAddPosY, cameraToAddPosZ, i, j, marchingPointX, marchingPointY, marchingPointZ, rayMarching, ref;
  for (i = j = 0; j < 200; i = ++j) {
    rayMarching = i * 0.1;
    ref = cameraVectorAhead(rayMarching, 0, 0), cameraToAddPosX = ref[0], cameraToAddPosY = ref[1], cameraToAddPosZ = ref[2];
...
tick = function() {
  var cameraMoveAmount, debugText, modelViewOrig, newScale, percentageBigger, ref, skipBecauseSlowDown;
  ticks++;
  fps_frameCount++;
...
keyPressed = function(e) {
  ...
  if (key === 'r') {
    if (currentlyOpenModal === examplesModal) {
      return examplesSelectList.selectedIndex = (examplesSelectList.selectedIndex + 1) % examplesSelectList.length;
    } else {
